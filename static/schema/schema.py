...
# Ordered list of fields in the normalized MCU data packet.
# Keep this list stable to preserve CSV column ordering and UI bindings.
_SCHEMA_PATH = os.path.join(os.path.dirname(__file__), "static", "schema", "schema.json")
...
def validate_and_map_command(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        validator(payload)
    # Mapping hook: if MCU expects different keys, transform here.
    return payload
